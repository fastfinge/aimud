"""
Commands about the world you are in: its rules, areas and how it runs.

Making, editing, deleting, resetting, listing and entering worlds are
the verb commands now; see commands/world_subject.py.
"""

from commands.command import Command
from commands.world_subject import current_world_root as _current_world_root
        ...
        if self.world_num is not None:
            ...
            if root is None:
                self.caller.msg(
                    ...
                    "|wview worlds|n to check one you are not standing in.")
                return
